...
function before_process() {
 ...
 $key = MODULE_PAYMENT_PAYMENTZ_WORKING_KEY;
  ...
  function get_error() {
    ...
    function keys() {
      return array('MODULE_PAYMENT_PAYMENTZ_STATUS', 'MODULE_PAYMENT_PAYMENTZ_MERCHANT_ID', 'MODULE_PAYMENT_PAYMENTZ_PARTNER_NAME', 'MODULE_PAYMENT_PAYMENTZ_WORKING_KEY', 'MODULE_PAYMENT_PAYMENTZ_TEST_URL', 'MODULE_PAYMENT_PAYMENTZ_LIVE_URL', 'MODULE_PAYMENT_PAYMENTZ_MODE', 'MODULE_PAYMENT_PAYMENTZ_SORT_ORDER', 'MODULE_PAYMENT_PAYMENTZ_ORDER_STATUS_ID', 'MODULE_PAYMENT_PAYMENTZ_ZONE');
    }
 }
